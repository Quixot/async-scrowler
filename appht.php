...
include( '/var/www/lib/phpQuery/phpQuery.php');
...
//if (file_exists($data_file_path) && date('H') != '11' || ENGINE_CURR == 'techport.ru') {
...
//if (ENGINE_TYPE == 'philips' || ENGINE_TYPE == 'polaris'  || ENGINE_TYPE == 'polaris.ua') {
