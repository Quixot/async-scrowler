...
var cookiesPath = '/var/www/polaris/engines/wildberries.ru/cookies_casual/'+casper.cli.get(6)+'.txt';
...
casper.start().each(global_page_links, function(self, link) {
	self.thenOpen(link, function() {
		casper.wait(2000, function() {
			...
			fs.write('/var/www/polaris/engines/wildberries.ru/content_casual/'+link.replace(/[^0-9a-zA-Z]/g, '')+'_'+casper.cli.get(6)+'.txt', this.getHTML(), 'w');
			this.capture("/var/www/polaris/engines/wildberries.ru/content_casual/"+link.replace(/[^0-9a-zA-Z]/g, '')+'_'+casper.cli.get(6)+".png");
		}).then(function () {
    	this.wait(5000);
    });
	});
