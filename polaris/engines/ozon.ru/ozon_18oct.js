...
casper.start(url, function() {
	...
	if (casper.getHTML()) {
		...
		//this.thenClick('span[class="b5u6"]', function () {
	    ...
	    //this.then(function() {
				...
				//fs.write('/var/www/polaris/engines/ozon.ru/content.txt', casper.getPageContent(), 'w');
					//this.capture("/var/www/polaris/engines/ozon.ru/ozon.png");	    	
	    	//this.sendKeys('input[autocomplete="off"]', casper.cli.get(6), {keepFocus: true}, casper.page.event.key.Enter, {keepFocus: true});
	    		this.click(x('//*[contains(text(),"'+casper.cli.get(7)+'")]'));
	    	//});	
	    });
	    //});
	    //this.sendKeys('input[class="ui-d5 ui-d7"]', casper.page.event.key.Enter, {keepFocus: true});
/*
