...
$links = array(
'https://www.ozon.ru/brand/17476997/',
'https://www.ozon.ru/brand/17476997/category/10500/',
'https://www.ozon.ru/brand/17476997/category/10531/',
'https://www.ozon.ru/brand/17476997/category/10533/',
'https://www.ozon.ru/brand/17476997/category/10525/',
'https://www.ozon.ru/brand/17476997/category/10563/',
'https://www.ozon.ru/brand/17476997/category/10572/',
'https://www.ozon.ru/brand/17476997/category/10581/',
'https://www.ozon.ru/brand/17476997/category/10582/',
'https://www.ozon.ru/brand/17476997/category/10594/',
'https://www.ozon.ru/brand/17476997/category/10621/',
'https://www.ozon.ru/brand/17476997/category/10625/',
'https://www.ozon.ru/brand/17476997/category/10649/',
'https://www.ozon.ru/brand/17476997/category/10651/',
'https://www.ozon.ru/brand/17476997/category/10680/',
'https://www.ozon.ru/brand/17476997/category/10684/',
'https://www.ozon.ru/brand/17476997/category/10713/',
'https://www.ozon.ru/brand/17476997/category/10714/',
'https://www.ozon.ru/brand/17476997/category/10720/',
'https://www.ozon.ru/brand/17476997/category/10721/',
'https://www.ozon.ru/brand/17476997/category/10723/',
'https://www.ozon.ru/brand/17476997/category/30793/',
'https://www.ozon.ru/brand/17476997/category/10739/',
'https://www.ozon.ru/brand/17476997/category/10740/',
'https://www.ozon.ru/brand/17476997/category/10743/',
'https://www.ozon.ru/brand/17476997/category/10745/',
'https://www.ozon.ru/brand/17476997/category/10750/',
'https://www.ozon.ru/brand/17476997/category/10756/',
'https://www.ozon.ru/brand/17476997/category/10786/',
'https://www.ozon.ru/brand/17476997/category/14500/',
'https://www.ozon.ru/brand/17476997/category/14505/',
'https://www.ozon.ru/brand/17476997/category/14514/',
'https://www.ozon.ru/brand/17476997/category/14508/',
'https://www.ozon.ru/brand/17476997/category/14522/',
'https://www.ozon.ru/brand/17476997/category/14513/',
'https://www.ozon.ru/brand/17476997/category/14527/',
'https://www.ozon.ru/brand/17476997/category/14855/',
'https://www.ozon.ru/brand/17476997/category/19021/',
'https://www.ozon.ru/brand/17476997/category/6500/',
'https://www.ozon.ru/brand/17476997/category/6527/',
'https://www.ozon.ru/brand/17476997/category/6338/'
	);

//$reg3 = "~class=\"bOneTile(.+)class=\"eIconButtonText\"~isU";
//$reg4 = "~class=\"eOzonPrice_main\".*>(.+)<.*href=\"(.+)\".*ItemName\">(.+)<~isU";
$reg3 = "~class=\"img-wrapper(.+)class=\"full-cover-link~isU";
$reg4 = "~class=\"main\".*>(.+)<.*href=\"(.+)\".*name-link\".*>(.+)<~isU";

$reg1 = "~class=\"preview(.+)class=\"full-cover-link~isU";
$reg2 = "~class=\"main\".*>(.+)<.*href=\"(.+)\".*name-link\".*>(.+)<~isU";
...
function regular_one($url) {
	...
	global $city;
		...
		//$url = 'https://www.ozon.ru/search/?brand=17476997&page=3&text=polaris';
		//$url = 'https://www.ozon.ru/brand/17476997/';
		$cmd = 'timeout -k 80s 81s casperjs /var/www/polaris/engines/ozon.ru/casper.js '.escapeshellarg($url).' '.escapeshellarg($useragent).' '.$matches_proxy[1].' '.$matches_proxy[2].' '.$matches_proxy[3].' '.$matches_proxy[4].' '."'".$city."'";
		echo 'request: '.$cmd.PHP_EOL;
		$response = exec($cmd, $out, $err);
		$response = implode(" ", $out);
		//echo $response;

		//file_put_contents('/var/www/polaris/engines/ozon.ru/'.time().'.txt', $response);


		if (strlen($response) > 500) {
			echo 'response ok'.PHP_EOL;
			
			preg_match("~jsButton\">(.+)<~isU", $response, $region);
			if (!$region) {
		  ...
		  if ($city == trim($region[1])) {
			  ...
			  foreach ($matches2 as $key => $value) {
					...
					//print_r($matches);
					if (@$matches[1] && $matches[2] && stripos($value[0], 'notify') === false && strripos($value[0], 'В наличии') !== false) {
						$matches[2] = trim($matches[2]);
						if (stripos($matches[2], '?') !== false) {
							$matches[2] = substr($matches[2], 0, stripos($matches[2], '?'));
						}
						$address = 'http://www.ozon.ru'.$matches[2];
