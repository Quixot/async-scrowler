...
casper.start('https://vstroyka-solo.ru/', function() {
	...
	this.then(function() {
		this.waitForSelector('#listView', function () {
			...
			this.wait(2000);
			this.click(x('//*[@div.class="pagination pagination-centered">li and text()="10"]'));
			this.waitForSelector('#listView', function () {
				...
				this.wait(2000);
				this.click(x('//*[@div.class="pagination pagination-centered">li and text()="15"]'));
				this.waitForSelector('#listView', function () {
					context = context+this.getHTML('#listView');  // 12
					this.echo('TRYING TO SAVE PAGE: # 12 !!!');
					//this.echo(JSON.stringify(this.getHTML('#listView')));
					//this.echo('STEP: # 3 !!!');
					//this.wait(20000);
