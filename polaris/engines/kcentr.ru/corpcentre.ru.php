 ...
 */
switch (EXTRA_PARAM) {
 	case 'yekaterinburg': $region = 'store[city]=%D0%95%D0%BA%D0%B0%D1%82%D0%B5%D1%80%D0%B8%D0%BD%D0%B1%D1%83%D1%80%D0%B3;;store[kladr]=66000001000'; break;    
  case 'novosibirsk': $region = 'store[city]=%D0%9D%D0%BE%D0%B2%D0%BE%D1%81%D0%B8%D0%B1%D0%B8%D1%80%D1%81%D0%BA;;store[kladr]=54000001000'; break;	
 	case 'perm': $region = 'store[city]=%D0%9F%D0%B5%D1%80%D0%BC%D1%8C;store[kladr]=59000001000'; break;
  case 'samara': $region = 'store[city]=%D0%A1%D0%B0%D0%BC%D0%B0%D1%80%D0%B0;store[kladr]=63000001000'; break;
 	case 'ufa': $region = 'store[city]=%D0%A3%D1%84%D0%B0;store[kladr]=02000001000'; break;
	...
	case  'arhangelsk':  $region = 'store[city]=%D0%90%D1%80%D1%85%D0%B0%D0%BD%D0%B3%D0%B5%D0%BB%D1%8C%D1%81%D0%BA;store[kladr]=29000001000'; break;
	...
	case  'vladivostok':  $region = 'store[city]=%D0%92%D0%BB%D0%B0%D0%B4%D0%B8%D0%B2%D0%BE%D1%81%D1%82%D0%BE%D0%BA;store[kladr]=25000001000'; break;
	...
	case  'kazan':  $region = 'store[city]=%D0%9A%D0%B0%D0%B7%D0%B0%D0%BD%D1%8C;store[kladr]=16000001000'; break;
	...
	case  'krasnodar':  $region = 'store[city]=%D0%9A%D1%80%D0%B0%D1%81%D0%BD%D0%BE%D0%B4%D0%B0%D1%80;store[kladr]=23000001000'; break;
	...
	case  'krasnoyarsk':  $region = 'store[city]=%D0%9A%D1%80%D0%B0%D1%81%D0%BD%D0%BE%D1%8F%D1%80%D1%81%D0%BA;store[kladr]=24000001000'; break;
	...
	case  'moscow':  $region = 'store[city]=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0;store[kladr]=77000000000'; break;
	...
	case  'novgorod':  $region = 'store[city]=%D0%9D%D0%B8%D0%B6%D0%BD%D0%B8%D0%B9+%D0%9D%D0%BE%D0%B2%D0%B3%D0%BE%D1%80%D0%BE%D0%B4;store[kladr]=52000001000'; break;
	...
	case  'omsk':  $region = 'store[city]=%D0%9E%D0%BC%D1%81%D0%BA;store[kladr]=55000001000'; break;
	...
	case  'petrozavodsk':  $region = 'store[city]=%D0%9F%D0%B5%D1%82%D1%80%D0%BE%D0%B7%D0%B0%D0%B2%D0%BE%D0%B4%D1%81%D0%BA;store[kladr]=10000001000'; break;
	case  'pskov':  $region = 'store[city]=%D0%9F%D1%81%D0%BA%D0%BE%D0%B2;store[kladr]=60000001000'; break;
	case  'pyatigorsk':  $region = 'store[city]=%D0%9F%D1%8F%D1%82%D0%B8%D0%B3%D0%BE%D1%80%D1%81%D0%BA;store[kladr]=26000007000'; break;
	case  'revda':  $region = 'store[city]=%D0%A0%D0%B5%D0%B2%D0%B4%D0%B0;store[kladr]=66000018000'; break;
	case  'rostov':  $region = 'store[city]=%D0%A0%D0%BE%D1%81%D1%82%D0%BE%D0%B2-%D0%BD%D0%B0-%D0%94%D0%BE%D0%BD%D1%83;store[kladr]=61000001000'; break;
	...
	case  'spb':  $region = 'store[city]=%D0%A1%D0%B0%D0%BD%D0%BA%D1%82-%D0%9F%D0%B5%D1%82%D0%B5%D1%80%D0%B1%D1%83%D1%80%D0%B3;store[kladr]=78000000000'; break;
	...
	case  'habarovsk':  $region = 'store[city]=%D0%A5%D0%B0%D0%B1%D0%B0%D1%80%D0%BE%D0%B2%D1%81%D0%BA;store[kladr]=27000001000'; break;
	...
	case  'cheboksary':  $region = 'store[city]=%D0%A7%D0%B5%D0%B1%D0%BE%D0%BA%D1%81%D0%B0%D1%80%D1%8B;store[kladr]=21000001000'; break;
	case  'chelyabinsk':  $region = 'store[city]=%D0%A7%D0%B5%D0%BB%D1%8F%D0%B1%D0%B8%D0%BD%D1%81%D0%BA;store[kladr]=74000001000'; break;
...
$options 	= array(CURLOPT_COOKIE => $region); 	// Подставляем coockie региона
$urlStart = 'http://www.' . ENGINE_CURR . '/search/?q=Polaris&s=';
$urlEnd   = '&PAGEN_1=';
...
$regexp1  = "~class=\"catalog-item(.+)wrap_compare~isU";
$regexp2  = "~class=\"wrap_title.*href=\"(.+)\".*>(.+)<.*class=\"wp_price\">(.+)<~isU";

	/**
	 * Поиск по vitek и rondell не работает
	 */
  	...
  	foreach ($matches2 as $key) {  		
			...
			if ($matches[1]) {
				if (strripos($key[1], 'span class="noisset"') === false) {
					price_change_detect('http://www.' . ENGINE_CURR . trim($matches[1]), trim($matches[2]), preg_replace('~[^\d]+~', '' ,$matches[3]), date("d.m.y-H:i:s"), $request->options[10004], $request->options[10006], $request->options[10018], ENGINE_CURR, ENGINE_TYPE);
					$itemsArray['http://www.' . ENGINE_CURR . trim($matches[1])] = array(
						trim($matches[2]), 
  ...
  if ($info['http_code'] !== 200) {
    if (stripos($info['url'], ENGINE_CURR)) {
  	...
  	foreach ($matches2 as $key) {  		
			...
			if ($matches[1]) {
				if (strripos($key[1], 'span class="noisset"') === false) {
					price_change_detect('http://www.' . ENGINE_CURR . trim($matches[1]), trim($matches[2]), trim(preg_replace('~[^\d]+~', '' ,$matches[3])), date("d.m.y-H:i:s"), $request->options[10004], $request->options[10006], $request->options[10018], ENGINE_CURR, ENGINE_TYPE);
					$itemsArray['http://www.' . ENGINE_CURR . trim($matches[1])] = array(
						trim($matches[2]), 
						trim(preg_replace('~[^\d]+~', '' ,$matches[3])),
						date("d.m.y-H:i:s"),
