...
function regular_one() {
	 ...
	 * Блок выбора прокси
	 */
	$cmd = 'timeout -k 40s 45s casperjs /var/www/engines/frau-technica.ru/casper.js '.escapeshellarg(ENGINE_TYPE).' '.escapeshellarg($useragent).' '.$matches_proxy[1].' '.$matches_proxy[2].' '.$matches_proxy[3].' '.$matches_proxy[4].' '.escapeshellarg($region);
