 ...
 */
	...
	foreach ($arrayOfDates as $date) {
		//if (strripos($date, '05.17') === false) { // Убираем май !!! KOSTYL !!!
			...
			$heap_file_path = 'http://attraktor:eldorado@'.($argv[2]=='rondell'?'176.36.102.174:3080/':'82.193.102.178:2080/').$argv[2].'/heap/'.$date.'_'.$argv[3].'.data';
...
// Код / Город / Сайт / Дата = РИЦ | Цена магазина | url | Name
	...
	$objWriter->save('/var/www/reporter/reports/big/Monitoring_'.ucfirst($argv[2]).'_'.$date_for_name.'_'.$argv[3].'.xlsx');
