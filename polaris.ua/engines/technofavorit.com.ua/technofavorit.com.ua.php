...
$regexpP2  		 = "~<a.*span>(.+)<~isU";  
$regexpPrices  = "~<li class=\"ajax_block_product(.+)class=\"product-flags~isU"; 
$regexpPrices2 = "~class=\"product-name.*href=\"(.+)\".*title=\"(.+)\".*product-price\">(.+)<~isU";
$regexpPrices3 = "~class=\"product-name.*href=\"(.+)\".*title=\"(.+)\"~isU";
$url = 'https://www.technofavorit.com.ua/search?controller=search&orderby=price&orderway=asc&search_query=polaris&submit_search=%D0%9F%D0%BE%D0%B8%D1%81%D0%BA';
...
$AC->get('https://www.technofavorit.com.ua/search?controller=search&orderby=price&orderway=asc&search_query=polaris&submit_search=%D0%9F%D0%BE%D0%B8%D1%81%D0%BA', null, $options);
$AC->get('https://www.technofavorit.com.ua/search?controller=search&orderby=price&orderway=asc&search_query=polaris&submit_search=%D0%9F%D0%BE%D0%B8%D1%81%D0%BA', null, $options);
