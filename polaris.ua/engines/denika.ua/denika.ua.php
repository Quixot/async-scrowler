...
$options = array(
								...
								//CURLOPT_COOKIEJAR       => '/var/www/polaris.ua/engines/denika.ua/cookies2.txt',
 ...
 */
$AC->get('https://denika.ua/search?keyword=polaris&brand=499&limit=72', null, $options); //&page=4
$AC->get('https://denika.ua/search?keyword=polaris&brand=499&limit=72', null, $options); //&page=4
...
function callback_one($response, $info, $request) {
  ...
  if ($info['http_code'] !== 200) {            
    $bad_urls[] = $request->url; 	
  	...
  	//file_put_contents('/var/www/polaris.ua/engines/denika.ua/content.txt', $response);die();
