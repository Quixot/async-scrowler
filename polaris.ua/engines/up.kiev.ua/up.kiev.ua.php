...
*/
$post_request = 'str=polairs';
$options = array(CURLOPT_HTTPHEADER => array('Content-Type:application/json', 'Content-Length: ' . strlen($post_request)));
$AC->request('https://up.kiev.ua/load/load_search.php', 'POST', $post_request, null, $options);
...
function callback_one($response, $info, $request) {
  ...
  global $bad_urls;
	...
	echo $response; 
	file_put_contents('/var/www/polaris.ua/engines/up.kiev.ua/cont.txt', $response);
	die();
